    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='doctor_app.User')),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ...
                ('hospital_affiliations', models.CharField(blank=True, max_length=100)),
